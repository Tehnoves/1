...
*	работаем с 
*	V1.0 05.11.14
*  	V2.0 07.11.14    TIC5231 + ј÷ѕ
*   V3.0 измеритель тока
*   V4.0 индикаци€ на матрице
*   V5.0 TIC120 
*   файл 887.c
*   RC1  -  LOAD
*   RC2  -  DIN
...
void minus() {
 ...
 void indik (void)
 {
	...
	void interrupt Interrupt()
		{
if ((PIE1bits.SSPIE==1)&(PIR1bits.SSPIF == 1 ))  //////////////////// ќ÷»‘–ќ¬ ј	
			{
				PIR1bits.SSPIF = 0;	
			}
...
////////	SPBRGL=(0xff & 206);								// !!!!!!!!!!!!! это 9600 не забудь вернуть 19200
			SPBRGH =(0xff & (206 >> 8));   
												...
												//	TXSTAbits.CSRC = 0X01;						// Asynchronous mode: DonТt care
													/*
